    ...
    return (
        ...
        >
            ...
            <div className="relative w-full bg-transparent flex flex-col items-center z-10 text-center px-4 py-20 gap-8">
                ...
                <div
                    className="flex lg:flex-row-reverse flex-col items-center justify-center gap-12 lg:gap-20 w-full max-w-6xl mx-auto px-4 perspective-distant"
                ...
                >
                    <motion.div
                        ...
                        className="relative w-48 h-72 md:w-56 md:h-80 xl:w-64 xl:h-100 group perspective-midrange cursor-pointer"
                        style={{ transformStyle: "preserve-3d" }}
                    >
                        {/*front side*/}
                        <motion.div
                            className="absolute w-full h-full rounded-xl overflow-hidden border-2 border-accent/50 bg-card shadow-[0_0_30px_-5px_hsl(var(--accent)/0.3)] backface-hidden"
                        ...
                        {/* back side */}
                        <motion.div
                            className="absolute w-full h-full rotate-y-180 rounded-xl overflow-hidden backface-hidden bg-card"
                            style={{ backfaceVisibility: "hidden" }}
                        >
                            {/* Centered Text */}
                            <div className="relative w-full h-full flex flex-col items-center justify-center gap-3 px-6">
                                <p
                                    className="font-heading font-black text-2xl md:text-3xl tracking-[0.15em] uppercase text-center leading-snug"
                                    style={{
                                        color: "hsl(var(--accent))",
                                        textShadow:
                                            "0 0 20px hsl(var(--accent) / 0.6), 0 0 40px hsl(var(--accent) / 0.3), 0 0 80px hsl(var(--accent) / 0.15)",
                                    }}
                                >
                                    nothing is true
                                </p>
                                <p
                                    className="font-heading font-light text-sm md:text-base tracking-[0.3em] uppercase text-center"
                                    style={{
